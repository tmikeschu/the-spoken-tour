...
const SuggestionInfo = ({ currentSuggestion, suggestionInfoIsActive }) => {
  ...
  return (
    <article className="SuggestionInfo">
      ...
      <p style={{ display: suggestionInfoIsActive ? "none" : "block" }}>
        (click an existing pin on the map)
      </p>
      <section
        className="text"
        style={{ display: suggestionInfoIsActive ? "initial" : "none" }}
      >
        <p>
          <span>Label</span>: {currentSuggestion.label}
        </p>
        <p>
          <span>Description</span>: {currentSuggestion.description}
        </p>
        <p>
          <span>Category</span>: {categories[currentSuggestion.category]}
        </p>
      </section>
    </article>
  )
